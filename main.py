...
def generate_and_send_line():
    ...
    prompt = (
        ...
        "記事の最初にあいさつ（こんにちは等）を入れないでください。"
        "記事の最後に、「AI×ショート動画で最速でマネタイズ（収益化）する具体的な手順と、豪華40大特典の受け取り方は、下記の固定記事で詳しく解説しています。↓↓↓【初期費用ゼロ】スキルなしの会社員や主婦がショート動画で最速で月収10万を達成したロードマップ」と入れてください。"
        "見出しを分かりやすく表示してください"
        "作成した文章に最適なハッシュタグを5つ考えて入れてください。"
        "「ゼロイチ」は“マネタイズにおける最初の1円”の意味のみで使用してください。"
        "読者に続きを読みたいと思わせるように、最初の数行を“読者の悩みや状況から書き始める”事を意識してください。"
