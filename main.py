...
def generate_and_send_line():
    ...
    prompt = (
        ...
        "1. AI×ショート動画の実践・検証記事\n"
        "2. ショート動画作成に使用するAIツールを使用してみた感想\n"
        "3. 初心者でもスマホやPCで今すぐ始められる具体的なAI副業のアイデア\n\n"
        "次のキーワードをタイトルに2つ以上含めてください。「AI副業」「ショート動画」「自動化」「タイパ」「コスパ」「ロードマップ」「ゼロイチ」。"
        ...
        "記事の最後に、「AI×ショート動画で最速でマネタイズ（収益化）する具体的な手順と、豪華40大特典の受け取り方は、こちらの【固定記事】で詳しく解説しています。」と入れてください。"
        "見出しを分かりやすく表示してください"
